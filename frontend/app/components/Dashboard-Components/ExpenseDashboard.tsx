          ...
          <div className="p-2 md:p-10 rounded-tl-2xl border border-neutral-700 bg-neutral-900 flex flex-row gap-2 flex-1 w-full h-full overflow-y-auto">
            ...
            <div className="flex flex-col gap-2 flex-1 w-3/5">
              <div className="flex gap-2 w-full">
                <div className="flex animate-pulse flex-col justify-center items-start px-10 h-32 w-full rounded-lg bg-gradient-to-t from-green-950 to-neutral-900 ">
                ...
                <div className="flex animate-pulse flex-col justify-center items-start px-10 h-32 w-full rounded-lg bg-gradient-to-t from-red-950 to-neutral-900 ">
                ...
                <div className="flex flex-col animate-pulse justify-center items-start px-10 h-32 w-full rounded-lg bg-gradient-to-t from-yellow-700 to-neutral-900 ">
                ...
                <div className="animate-pulse flex flex-col justify-center items-start px-10 h-32 w-full rounded-lg bg-gradient-to-t from-zinc-800 to-neutral-900 ">
              ...
              <div className="flex gap-2 flex-1 w-full h-full">
                <div className="w-full animate-pulse h-96 rounded-lg bg-neutral-800 flex justify-center items-center overflow-hidden">
                  {/* <BarChart /> */}
                </div>
                <div className="animate-pulse w-full p-6 rounded-lg bg-neutral-800 flex flex-col justify-start items-start overflow-hidden">
              ...
              <div className="h-full w-full rounded-lg bg-neutral-800 flex justify-center items-center animate-pulse">
