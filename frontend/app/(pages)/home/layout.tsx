...
import { userFinancialAtom } from "@/app/store/atoms/user-financial-info";
...
export default function HomeLayout({
    ...
    const [userFinancialInfo, setUserFinancialInfo] = useRecoilState(userFinancialAtom);
